...
from met_museum._exceptions import APITimeoutError, APIStatusError, APIResponseValidationError
...
from met_museum import MetMuseum, AsyncMetMuseum, APIResponseValidationError
from met_museum._models import FinalRequestOptions, BaseModel
from met_museum._types import NOT_GIVEN, Headers, NotGiven, Query, Body, Timeout, Omit
from met_museum._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, RequestOptions, make_request_options
from met_museum._streaming import Stream, AsyncStream
from met_museum._constants import RAW_RESPONSE_HEADER
from met_museum._response import APIResponse, AsyncAPIResponse
from met_museum._types import Omit
...
def _get_open_connections(client: MetMuseum | AsyncMetMuseum) -> int:
...
class TestMetMuseum:
    ...
    def test_copy_default_headers(self) -> None:
        client = MetMuseum(base_url=base_url, _strict_response_validation=True, default_headers={
            "X-Foo": "bar"
        })
    ...
    def test_copy_default_query(self) -> None:
        client = MetMuseum(base_url=base_url, _strict_response_validation=True, default_query={
            "foo": "bar"
        })
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "met_museum/_legacy_response.py",
                        "met_museum/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "met_museum/_compat.py",
    ...
    def test_client_timeout_option(self) -> None:
        client = MetMuseum(base_url=base_url, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = MetMuseum(base_url=base_url, _strict_response_validation=True, default_headers={
            "X-Foo": "stainless",
    ...
    def test_multipart_repeating_array(self, client: MetMuseum) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = MetMuseum(base_url="https://example.com/from_init", _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(MET_MUSEUM_BASE_URL='http://localhost:5000/from/env'):
          client = MetMuseum(_strict_response_validation=True)
          assert client.base_url == 'http://localhost:5000/from/env/'

    @pytest.mark.parametrize("client", [MetMuseum(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True), MetMuseum(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True, http_client=httpx.Client())], ids = ["standard", "custom http client"])
    def test_base_url_trailing_slash(self, client: MetMuseum) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    @pytest.mark.parametrize("client", [MetMuseum(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True), MetMuseum(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True, http_client=httpx.Client())], ids = ["standard", "custom http client"])
    def test_base_url_no_trailing_slash(self, client: MetMuseum) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    @pytest.mark.parametrize("client", [MetMuseum(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True), MetMuseum(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True, http_client=httpx.Client())], ids = ["standard", "custom http client"])
    def test_absolute_request_url(self, client: MetMuseum) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
          MetMuseum(base_url=base_url, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = MetMuseum(base_url=base_url, _strict_response_validation=True)
...
class TestAsyncMetMuseum:
    ...
    def test_copy_default_headers(self) -> None:
        client = AsyncMetMuseum(base_url=base_url, _strict_response_validation=True, default_headers={
            "X-Foo": "bar"
        })
        assert client.default_headers['X-Foo'] == 'bar'
    ...
    def test_copy_default_query(self) -> None:
        client = AsyncMetMuseum(base_url=base_url, _strict_response_validation=True, default_query={
            "foo": "bar"
        })
        assert _get_params(client)['foo'] == 'bar'
    ...
    async def test_client_timeout_option(self) -> None:
        client = AsyncMetMuseum(base_url=base_url, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_default_headers_option(self) -> None:
        ...
        client2 = AsyncMetMuseum(base_url=base_url, _strict_response_validation=True, default_headers={
            "X-Foo": "stainless",
            "X-Stainless-Lang": "my-overriding-header",
        })
        request = client2._build_request(FinalRequestOptions(method="get", url='/foo'))
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMetMuseum) -> None:
    ...
    @pytest.mark.parametrize("client", [AsyncMetMuseum(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True), AsyncMetMuseum(base_url="http://localhost:5000/custom/path/", _strict_response_validation=True, http_client=httpx.AsyncClient())], ids = ["standard", "custom http client"])
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMetMuseum(base_url=base_url, _strict_response_validation=True)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await self.client.get("/objects/0", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}})
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.collections.with_raw_response.retrieve(0, extra_headers={'x-stainless-retry-count': Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.collections.with_raw_response.retrieve(0, extra_headers={'x-stainless-retry-count': '42'})
