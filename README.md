...
The REST API documentation can be found on [docs.met-museum.com](https://docs.met-museum.com). The full API of this library can be found in [api.md](api.md).

## Installation

```sh
# install from this staging repo
pip install git+ssh://git@github.com/stainless-sdks/met-museum-python.git
```

> [!NOTE]
> Once this package is [published to PyPI](https://app.stainlessapi.com/docs/guides/publish), this will become: `pip install --pre met_museum`
...
You can enable logging by setting the environment variable `MET_MUSEUM_LOG` to `debug`.

```shell
$ export MET_MUSEUM_LOG=debug
```
...
The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/met-museum-python/tree/main/src/met_museum/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/met-museum-python/issues) with questions, bugs, or suggestions.
